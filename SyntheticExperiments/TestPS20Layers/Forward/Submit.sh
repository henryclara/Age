#!/bin/bash
#SBATCH -o /work/bm1164/m300832/Age/SyntheticExperiments//TestPS20Layers/Forward/SLURM_job.%j.%N.out
#SBATCH -e /work/bm1164/m300832/Age/SyntheticExperiments//TestPS20Layers/Forward/SLURM_job.%j.%N.err
#SBATCH -D /work/bm1164/m300832/Age/SyntheticExperiments//TestPS20Layers/Forward
