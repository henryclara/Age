#!/bin/bash
#SBATCH -o /work/bm1164/m300832/Age/SyntheticExperiments//Test2D/Init/SLURM_job.%j.%N.out
#SBATCH -e /work/bm1164/m300832/Age/SyntheticExperiments//Test2D/Init/SLURM_job.%j.%N.err
#SBATCH -D /work/bm1164/m300832/Age/SyntheticExperiments//Test2D/Init
...
if [ "${YearCounter}" -lt "2" ]; then
	if [ "1" -eq 1 ]; then
					cp Mesh/*result* /work/bm1164/m300832/Age/SyntheticExperiments//Test2D/Forward/Mesh/
					cp Mesh/mesh* /work/bm1164/m300832/Age/SyntheticExperiments//Test2D/Forward/Mesh/
					cd /work/bm1164/m300832/Age/SyntheticExperiments//Test2D/Forward
